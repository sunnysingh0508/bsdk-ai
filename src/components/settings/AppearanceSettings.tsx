...
export default function AppearanceSettings() {
    ...
    return (
        <div className="bg-card rounded-[24px] p-6 border border-border space-y-6">
            ...
            {/* Theme Toggle */}
            <div>
                <label className="text-xs text-muted-foreground font-medium mb-3 block">Theme Preference</label>
            ...
            {/* Accent Color */}
            <div>
                <label className="text-xs text-muted-foreground font-medium mb-3 block">Accent Color</label>

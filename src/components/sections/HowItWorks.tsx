...
export function HowItWorks() {
    return (
        <SectionWrapper id="how-it-works" className="bg-[#F8F9FC]">
            ...
            <div className="relative mx-auto max-w-4xl">
                ...
                <div className="absolute left-0 top-12 hidden h-0.5 w-full bg-gray-200 md:block" />

                <div className="grid gap-8 md:grid-cols-3">
                    {steps.map((step, index) => (
                        <div key={index} className="relative flex flex-col items-center text-center">
                            <div className="mb-6 flex h-24 w-24 items-center justify-center rounded-full bg-white shadow-lg border border-gray-100 z-10 transition-transform duration-300 hover:scale-110">

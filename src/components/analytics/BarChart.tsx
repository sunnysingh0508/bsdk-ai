...
export default function BarChart({ data }: { data: BarData[] }) {
    return (
        <div className="bg-card rounded-[24px] border border-border p-6 h-full">
            <div className="flex items-center justify-between mb-6">
                <h3 className="text-lg font-bold text-foreground">Assignments Performance</h3>
                    ...
                    return (
                        <div key={i} className="group">
                            <div className="flex justify-between text-sm mb-1.5">
                                ...
                                <span className="text-xs text-muted-foreground">{Math.round(pCompleted)}% Done</span>
                            </div>

...
export function AuthVisual() {
    return (
        <div className="relative hidden h-full w-full flex-col items-center justify-center bg-muted lg:flex overflow-hidden">
            ...
            <div className="absolute -right-20 bottom-20 h-[500px] w-[500px] rounded-full bg-secondary/10 blur-[100px]" />
            ...
            <div className="relative z-10 w-full max-w-[500px] p-8 perspective-[1000px]">
                ...
                <div className="grid grid-cols-2 gap-4 transition-transform duration-500 hover:rotate-y-3 hover:rotate-x-3 preserve-3d">
                    ...
                    {/* Stat 1: CGPA */}
                    <Card className="col-span-1 p-5 glass border-border/50 shadow-lg">
                        ...
                        <Badge variant="secondary" className="mt-2 bg-green-500/10 text-green-600 text-[10px]">+0.4 from last sem</Badge>
                    </Card>

                    {/* Stat 2: Assignments */}
                    <Card className="col-span-1 p-5 glass border-border/50 shadow-lg bg-background/50">
                        <div className="flex items-center justify-between mb-4">
                            <span className="text-xs font-semibold text-muted-foreground">Pending Tasks</span>
                            <BookOpen className="h-4 w-4 text-pink-500" />
                        </div>
                        <div className="text-3xl font-bold text-foreground">4</div>
                        <p className="mt-2 text-[10px] text-destructive font-medium">2 deadlines today</p>
                    </Card>

                    {/* Wide Card: Schedule */}
                    <Card className="col-span-2 p-5 glass border-border/50 shadow-lg">
                    ...
                    <Card className="absolute -right-12 top-10 w-48 p-3 shadow-xl animate-float glass border-border/50 hidden xl:block">

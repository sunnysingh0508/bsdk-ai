        ...
        <div className="relative rounded-[24px] overflow-hidden bg-[#181B23] border border-white/5 mb-6 group">
            ...
            <div className="px-8 pb-8 flex flex-col md:flex-row items-start md:items-end gap-6 -mt-12">
                ...
                <div className="relative group/avatar cursor-pointer">
                    <div className="w-32 h-32 rounded-full border-4 border-[#181B23] bg-indigo-100 flex items-center justify-center text-4xl font-bold text-[#6366F1] shadow-2xl">
                        S
                    </div>
                ...
                <div className="flex-1 pb-2">
                    <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                        ...
                        <div className="flex gap-3">
                            <button className="px-4 py-2 rounded-xl bg-white/5 hover:bg-white/10 text-white text-sm font-medium transition-colors border border-white/5">
                                Change Photo
                            </button>
                        </div>
                    </div>

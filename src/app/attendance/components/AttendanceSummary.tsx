...
export function AttendanceSummary({ average, totalSubjects, totalAttended, totalClasses }: AttendanceSummaryProps) {
    return (
        <div className="rounded-[24px] bg-[#181B23] p-6 border border-white/5 shadow-lg relative overflow-hidden">
            <div className="absolute top-0 right-0 p-4 opacity-5">
                <div className="h-32 w-32 rounded-full border-8 border-indigo-500" />
            </div>
            ...
            <div className="grid grid-cols-2 lg:grid-cols-4 gap-6 relative z-10">
                <div className="flex flex-col">
                    <span className="text-3xl font-bold text-white mb-1">{average.toFixed(1)}%</span>
                    <span className="text-xs text-muted-foreground">Average Attendance</span>
                </div>

                <div className="flex flex-col">
                    <span className="text-3xl font-bold text-white mb-1">{totalSubjects}</span>
